            ...
            <div class="box1">
                <form action="" class="form" method="post">
                    ...
                    <div class="side_by_side">
                        <input class="number" type="number" min="1" name="product_quantity" value="1">
                    ...
                    <div>
                        <a class="extra_btn" href="details.php?id=' . $id . '& idd=2"> <i class="fa fa-eye" aria-hidden="true"></i>  </a>
                    </div>
                </form>
            </div>
        ';
...
<script>
  document.getElementById("showCartButton").addEventListener("click", function(event) {
    ...
    <footer class="footer" style="font-size: 1.01rem;">
        <div class="container">
            <div class="social-icons" style="min-width:250px; wrap-content:wrap">
