...
<head>
  ...
  <link rel="stylesheet" media="screen and (max-width: 560px)" href="phonee.css">
  ...
  <style>
    ...
    .inner-container {
      min-width: 800px;
      /* Ensure inner container doesn't overflow */
    }
...
<body>
  ...
  <section id="feature" class="section.p1">
    <?php
    // Display products
    $sql = "SELECT * FROM children_images";
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        <div class="box1">
            <form action="" class="form" method="post">
                ...
                <div>
                <a class="extra_btn" href="details.php?id='.$id.'& idd=3"> <i class="fa fa-eye" aria-hidden="true"></i>  </a>
                </div>
            </form>
        </div>
    ';
            ...
            if ($numRows = 1) {
                ...
                if (isset($_POST['add_to_cart'])) {
                    ...
                    if (mysqli_num_rows($select_cart) > 0) {
                        ...
                        mysqli_query($conn, "INSERT INTO `cart_item` (product_name , user_id , email , price,Image, qantity , Order_status) VALUES ('$product_name', '$user_id','$email','$product_price','$product_image','$product_quantity' , '2')") or die("Something is wrong will fix soon");
                        $msg = "Product Added!";
                    }
